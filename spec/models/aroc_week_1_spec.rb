...
# ----------------------
  ...
  it '6. finds multiple orders by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    # x = Order.find(ids_to_find) Finds the same orders but orders it differently, why?
  ...
  it '7. finds orders with an amount between 700 and 1000' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Order.where('amount >= ?', 700).where('amount <= ?', 1000) -- is there a benefit to doing it like this?
